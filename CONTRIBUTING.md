...
repository](https://github.com/IBM/personal-wealth-portfolio-mgt-bot).

A good way to familiarize yourself with the codebase and contribution process is
to look for and tackle low-hanging fruit in the [issue
tracker](https://github.com/IBM/personal-wealth-portfolio-mgt-bot/issues). Before embarking on
...
issue](https://github.com/IBM/personal-wealth-portfolio-mgt-bot/issues) before sending a pull
