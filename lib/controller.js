    ...
    getUser(user).then(function(dbUser) {
      ...
      .then(function(messageResponse) {
        ...
        .then (function (options) {
          ...
          if (intent == 'hello')
             return _messageResponse;
          else if (intent == "portfolio_performance_today" || intent == "portfolio_holdings" || intent == "portfolio_impact_analysis")
          {   //Get the Investment Portfolio Holdings
              ...
              else if( intent == "portfolio_performance_today" || intent == "porfolio_holdings")
              {
