...
var port_userId = investmentPortfolioCredentials.writer.userid || process.env.CRED_PORTFOLIO_USERID;
var port_pwd = investmentPortfolioCredentials.writer.password || process.env.CRED_PORTFOLIO_PWD;
...
//console.log('scenario file2 ', simulated_instrument_analytics_scenariofile);
//console.log('token2 ', simulated_instrument_analytics_accesstoken);
//console.log('url2 ', simulated_instrument_analytics_url);
...
function getRiskAnalyticsRP(instrument) {
  ...
  form.append('scenario_file', fs.createReadStream('./resources/spdown5_scenario.csv'));
            ...
            else
            {
              ...
              .then( function(riskAnalyticsResponse) {
                ...
                else //intent is portfolio impact
                {
                    ...
                    console.log("response ", JSON.stringify(portImpactResponse));
