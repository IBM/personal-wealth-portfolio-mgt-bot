...
console.log('scenario file ', simulated_instrument_analytics_scenariofile);
console.log('token ', simulated_instrument_analytics_accesstoken);
console.log('url ', simulated_instrument_analytics_url);
