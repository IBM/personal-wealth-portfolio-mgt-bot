...
var port_userId = investmentPortfolioCredentials.writer.username || process.env.CRED_PORTFOLIO_USERID;
...
port_url = port_url + "api/vi/portfolios";

console.log('userid ', port_userId);
console.log('pwd ', port_pwd);
console.log('url ', port_url);
